...
proc create_root_design { parentCell } {
  ...
  set M_AXI_ZYNQ [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_ZYNQ ]
  ...
  set dcm_locked [ create_bd_port -dir O dcm_locked ]
  set noop_aresetn [ create_bd_port -dir O -from 0 -to 0 -type rst noop_aresetn ]
  set uncore_aresetn [ create_bd_port -dir O -from 0 -to 0 -type rst uncore_aresetn ]
  set uncoreclk [ create_bd_port -dir O -type clk uncoreclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXI_MEM:M_AXI_ZYNQ} \
   CONFIG.ASSOCIATED_RESET {noop_aresetn} \
 ] $uncoreclk
  set vgaclk [ create_bd_port -dir O -type clk vgaclk ]

  # Create instance: armv7_processing_system, and set properties
  set armv7_processing_system [ create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 armv7_processing_system ]
  set_property -dict [ list \
   ...
   CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 {0.283} \
   CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 {0.276} \
   CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY2 {0.29} \
   CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY3 {0.294} \
   ...
   CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_0 {0.115} \
   CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_1 {0.133} \
   CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_2 {0.112} \
   CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_3 {0.09} \
   ...
   CONFIG.PCW_UIPARAM_DDR_T_FAW {30} \
  ...
  connect_bd_intf_net -intf_net S_AXI_MEM_1 [get_bd_intf_ports S_AXI_MEM] [get_bd_intf_pins axi_protocol_converter_0/S_AXI]
  connect_bd_intf_net -intf_net armv7_processing_system_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins armv7_processing_system/DDR]
  connect_bd_intf_net -intf_net armv7_processing_system_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins armv7_processing_system/FIXED_IO]
  connect_bd_intf_net -intf_net armv7_processing_system_UART_0 [get_bd_intf_ports UART_0] [get_bd_intf_pins armv7_processing_system/UART_0]
  connect_bd_intf_net -intf_net armv7_ps_M_AXI_GP0 [get_bd_intf_pins armv7_processing_system/M_AXI_GP0] [get_bd_intf_pins axi3_to_lite_pc/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_crossbar_0_M00_AXI [get_bd_intf_ports M_AXI_ZYNQ] [get_bd_intf_pins axi_crossbar_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_protocol_converter_0_M_AXI [get_bd_intf_pins armv7_processing_system/S_AXI_HP0] [get_bd_intf_pins axi_protocol_converter_0/M_AXI]
  ...
  connect_bd_net -net armv7_processing_system_FCLK_RESET0_N [get_bd_pins armv7_processing_system/FCLK_RESET0_N] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports noop_aresetn] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports coreclk] [get_bd_ports uncoreclk] [get_bd_pins armv7_processing_system/M_AXI_GP0_ACLK] [get_bd_pins armv7_processing_system/S_AXI_HP0_ACLK] [get_bd_pins axi3_to_lite_pc/aclk] [get_bd_pins axi_crossbar_0/aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_ports vgaclk] [get_bd_pins clk_wiz_0/clk_out3]
  connect_bd_net -net clk_wiz_0_locked [get_bd_ports dcm_locked] [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_ports uncore_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net ps_user_reset_n [get_bd_pins axi3_to_lite_pc/aresetn] [get_bd_pins axi_crossbar_0/aresetn] [get_bd_pins axi_protocol_converter_0/aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00020000 -offset 0x40000000 [get_bd_addr_spaces armv7_processing_system/Data] [get_bd_addr_segs M_AXI_ZYNQ/Reg] SEG_M_AXI_ZYNQ_Reg
  ...
  create_bd_addr_seg -range 0x10000000 -offset 0x10000000 [get_bd_addr_spaces S_AXI_MEM] [get_bd_addr_segs armv7_processing_system/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_armv7_processing_system_HP0_DDR_LOWOCM
