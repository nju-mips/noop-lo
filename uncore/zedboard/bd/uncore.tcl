...
################################################################
# This is a generated script based on design: uncore
#
...
proc create_root_design { parentCell } {
  ...
  set S_AXI_DEVICE [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_DEVICE ]
  ...
  set S_AXI_ZYNQ [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_ZYNQ ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
   CONFIG.ARUSER_WIDTH {0} \
   CONFIG.AWUSER_WIDTH {0} \
  ...
  # Create ports
  set GPIO_trap [ create_bd_port -dir O -from 7 -to 0 GPIO_trap ]
  set timer_interrupt [ create_bd_port -dir O -type intr timer_interrupt ]
  set uncore_aresetn [ create_bd_port -dir I -type rst uncore_aresetn ]
  set uncoreclk [ create_bd_port -dir I -type clk uncoreclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S_AXI_ZYNQ:S_AXI_DEVICE} \
   CONFIG.ASSOCIATED_RESET {noop_io_aresetn:zynq_io_aresetn:uncore_aresetn} \
   CONFIG.FREQ_HZ {50000000} \
 ] $uncoreclk
  set vgaclk [ create_bd_port -dir I -type clk vgaclk ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {50000000} \
 ] $vgaclk
  ...
  # Create instance: axi_crossbar_peripheral, and set properties
  set axi_crossbar_peripheral [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_crossbar:2.1 axi_crossbar_peripheral ]
  set_property -dict [ list \
 ...
 ] $axi_crossbar_peripheral

  # Create instance: axi_gpio_trap, and set properties
  set axi_gpio_trap [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_trap ]
  set_property -dict [ list \
  ...
  set block_name axi_vga
  set block_cell_name axi_vga_0
  if { [catch {set axi_vga_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
   CONFIG.MAX_BURST_LENGTH {1} \
 ] [get_bd_intf_pins /axi_vga_0/axi]

  # Create instance: proc_sys_reset_0, and set properties
  set proc_sys_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net S_AXI_DEVICE_1 [get_bd_intf_ports S_AXI_DEVICE] [get_bd_intf_pins axi_crossbar_peripheral/S00_AXI]
  connect_bd_intf_net -intf_net S_AXI_ZYNQ_1 [get_bd_intf_ports S_AXI_ZYNQ] [get_bd_intf_pins axi_crossbar_peripheral/S01_AXI]
  connect_bd_intf_net -intf_net axi_clock_converter_0_M_AXI [get_bd_intf_pins axi_clock_converter_0/M_AXI] [get_bd_intf_pins axi_vga_0/axi]
  connect_bd_intf_net -intf_net axi_crossbar_0_M00_AXI [get_bd_intf_pins axi_crossbar_peripheral/M00_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI]
  connect_bd_intf_net -intf_net axi_crossbar_peripheral_M01_AXI [get_bd_intf_pins axi_clock_converter_0/S_AXI] [get_bd_intf_pins axi_crossbar_peripheral/M01_AXI]
  connect_bd_intf_net -intf_net axi_crossbar_peripheral_M02_AXI [get_bd_intf_pins axi_crossbar_peripheral/M02_AXI] [get_bd_intf_pins axi_gpio_trap/S_AXI]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports UART] [get_bd_intf_pins axi_uartlite_0/UART]
  connect_bd_intf_net -intf_net axi_vga_0_VGA [get_bd_intf_ports VGA] [get_bd_intf_pins axi_vga_0/VGA]

  # Create port connections
  connect_bd_net -net axi_gpio_trap_gpio_io_o [get_bd_ports GPIO_trap] [get_bd_pins axi_gpio_trap/gpio2_io_i] [get_bd_pins axi_gpio_trap/gpio_io_o]
  connect_bd_net -net clk_1 [get_bd_ports uncoreclk] [get_bd_pins axi_clock_converter_0/s_axi_aclk] [get_bd_pins axi_crossbar_peripheral/aclk] [get_bd_pins axi_gpio_trap/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_clock_converter_0/m_axi_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_vga_0/axi_resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net vgaclk_1 [get_bd_ports vgaclk] [get_bd_pins axi_clock_converter_0/m_axi_aclk] [get_bd_pins axi_vga_0/axi_clk] [get_bd_pins axi_vga_0/vga_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net zynq_interconnect_aresetn_1 [get_bd_ports uncore_aresetn] [get_bd_pins axi_clock_converter_0/s_axi_aresetn] [get_bd_pins axi_crossbar_peripheral/aresetn] [get_bd_pins axi_gpio_trap/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/ext_reset_in]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces S_AXI_DEVICE] [get_bd_addr_segs axi_gpio_trap/S_AXI/Reg] SEG_axi_gpio_trap_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces S_AXI_ZYNQ] [get_bd_addr_segs axi_gpio_trap/S_AXI/Reg] SEG_axi_gpio_trap_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40001000 [get_bd_addr_spaces S_AXI_DEVICE] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x40001000 [get_bd_addr_spaces S_AXI_ZYNQ] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
  create_bd_addr_seg -range 0x00100000 -offset 0x50000000 [get_bd_addr_spaces S_AXI_DEVICE] [get_bd_addr_segs axi_vga_0/axi/reg0] SEG_axi_vga_0_reg0
  create_bd_addr_seg -range 0x00100000 -offset 0x50000000 [get_bd_addr_spaces S_AXI_ZYNQ] [get_bd_addr_segs axi_vga_0/axi/reg0] SEG_axi_vga_0_reg0
