...
add_files -norecurse -fileset sources_1 "[file normalize "${rtl_dir}/RAM_INTERFACE/data_ram_delay.v"]"
add_files -norecurse -fileset sources_1 "[file normalize "${rtl_dir}/RAM_INTERFACE/inst_ram_delay.v"]"
add_files -norecurse -fileset sources_1 "[file normalize "${rtl_dir}/RAM_INTERFACE/random_mask.v"]"
...
add_files -norecurse -fileset sources_1 "[file normalize "${ip_dir}/axi_crossbar_0/axi_crossbar_0.xci"]"

# Set COE file
set_property -dict "[list CONFIG.Load_Init_File {true} CONFIG.Coe_File [file normalize "${data_dir}/data_ram.coe"]]" [get_ips data_ram]
set_property -dict "[list CONFIG.Load_Init_File {true} CONFIG.Coe_File [file normalize "${data_dir}/inst_ram.coe"]]" [get_ips inst_ram]
